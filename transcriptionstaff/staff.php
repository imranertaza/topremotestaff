                                                                        ...
                                                                        <div id="email_template" class="tabcontent p-1">
                                                                            ...
                                                                            <div id="email_template"
                                                                                ...
                                                                                <script>
                                                                                    ...
                                                                                    // const negativewordsBtnSaveBtn = document.getElementById("negativewordsBtn13");
                                                                                    //
                                                                                    // const negativewordsField13 = document.getElementById("negativewordsField13");
                                                                                    // let validNagativeWord ;
                                                                                    // let negativewordsField13Value;
                                                                                    //
                                                                                    // try {
                                                                                    //      negativewordsField13Value =  JSON.parse(negativewordsField13.value);
                                                                                    // }catch (err){
                                                                                    //     if(err){
                                                                                    //         validNagativeWord = false;
                                                                                    //     }
                                                                                    // }
                                                                                    // console.log(validNagativeWord);
                                                                                    // negativewordsBtnSaveBtn.addEventListener('click',()=>{
                                                                                    //     console.log(validNagativeWord);
                                                                                    //     console.log(negativewordsField13Value)
                                                                                    // })
