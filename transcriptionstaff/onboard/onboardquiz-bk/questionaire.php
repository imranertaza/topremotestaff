<?php 
	...
	$getQCQuestions = mysqli_query($db, "SELECT * FROM bk_list_of_questions WHERE status='1' ORDER BY date_created ASC");
...
<html lang="en">
  <head>
    ...
    <title>OnboardQuiz - Add Questions - Bookkeeping</title>
	<style>
		table{
