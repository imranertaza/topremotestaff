...
<html lang="en">
  <head>
   ...
   <title>OnboardQuiz - Proofreading</title>
			...
			<div class="row align-items-center justify-content-md-center">
				...
				<?php
					...
					$allquestions = array();
						...
						$getQuestions = mysqli_query($db, "SELECT * FROM pr_list_of_questions WHERE status='1' ORDER BY date_created ASC");
				...
				var email = $("#email").val();
					 ...
					 $.ajax({
						...
						//	console.log(data);
							...
							if(score == 0){
								alert("Please review the correct answers, and do the test again.   You may proceed to account creation after getting the test 100% correct.");
							}else{
								window.location.href = "http://proofreading.topremotestaff.com/createaccounts/";
							}
						}
					 });
