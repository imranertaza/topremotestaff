...
if(!isset($_GET['tab']) || (isset($_GET['tab']) && $_GET['tab'] == "pending")) {
	$getProofReadData = mysqli_query($db, "SELECT * FROM ts_graphics_users WHERE status='0' ORDER BY date_created DESC");
	$proofReadResult = mysqli_fetch_all($getProofReadData, MYSQLI_ASSOC);
}
if(isset($_GET['tab']) && $_GET['tab'] == "approved") {
	$getProofReadApproved = mysqli_query($db, "SELECT * FROM ts_graphics_users WHERE status='1' ORDER BY date_updated DESC");
										...
										<div class="modal-content" style="width: 45%;">
											 ...
											 <div class="modal-body" style="padding-bottom:24px">
												...
												<?php
													...
													$getProofReadTestResult = mysqli_query($db, "SELECT * FROM ts_graphics_answers WHERE proofread_user_id='$id'");
