...
$FileUpload = new FileUpload();
    ...
    foreach($allIds as $id) {
        $selectQuery = $crud->getSelectedData('cv', 'ts_graphics_users', "id", $id);
    ...
    $queryQu = $crud->deleteAll('ts_graphics_answers', "graphics_user_id", $_POST['staff_ids']);
    $db->query($queryQu);
    //deleting question answer

	$query = $crud->deleteAll('ts_graphics_users', "id", $_POST['staff_ids']);
