...
//                                                            }
                                                        ...
                                                        $score =  ($test_1_result['score'] + $test_2_result['score'] + $test_3_result['score'] + $test_4_result['score'] + $test_5_result['score'])/5;
...
//                                                            print $test_1_result['not_included'].'<br>';
//                                                            print $test_2_result['not_included'].'<br>';
//                                                            print $test_3_result['not_included'].'<br>';
//                                                            print $test_4_result['not_included'].'<br>';
//                                                            print $test_5_result['not_included'].'<br>';
                                                        ...
                                                        <?php if ($total != $score) { ?>
															...
															<p style="color:#000;margin:0;font-size:14px;padding-left:4px;"><strong>Score: </strong><?php echo $score; ?></p>
...
<!--                                                                        <span><strong>Score: </strong>--><?php //echo $score . "/" . $total; ?><!--</span>-->
                                                    ...
                                                    <td class="rating<?php echo $score; ?> <?php echo ($duplicated_ip > 0) ? "duplicateip" : ""; ?> <?php echo ($result[$x]['code'] == "" || $result[$x]['code'] == null) ? "nocode" : ""; ?>
                                                    <?php
//                                                    $content = htmlentities(urldecode($result[$x]['content']));
//                                                    $kerywords = json_decode($testDataResult2[0]['keywords']);
//                                                    $negative_keywords = json_decode($testDataResult2[0]['negative_keywords']);
...
//                                                   }
                                                    ...
                                                    $test_1_not_invluded =  $getScore->negative_keyword_not_included($resultTest[0]['test_1_id'],$resultTest[0]['test_1_content']);
                                                    $test_2_not_invluded =  $getScore->negative_keyword_not_included($resultTest[0]['test_2_id'],$resultTest[0]['test_2_content']);
                                                    $test_3_not_invluded =  $getScore->negative_keyword_not_included($resultTest[0]['test_3_id'],$resultTest[0]['test_3_content']);
                                                    $test_4_not_invluded =  $getScore->negative_keyword_not_included($resultTest[0]['test_4_id'],$resultTest[0]['test_4_content']);
                                                    $test_5_not_invluded =  $getScore->negative_keyword_not_included($resultTest[0]['test_5_id'],$resultTest[0]['test_5_content']);

                                                    $t_all_not_included = $test_1_not_invluded + $test_2_not_invluded + $test_3_not_invluded + $test_4_not_invluded + $test_5_not_invluded;

                                                    if ($t_all_not_included == 0) {
                                                        echo "negative-keyword-content";
                                                    }
                                                    ...
                                                    " >
                                                        <?php
                                                            //echo $t_all_not_included.'<br>';
//                                                            echo $test_1_not_invluded.'<br>';
//                                                            echo $test_2_not_invluded.'<br>';
//                                                            echo $test_3_not_invluded.'<br>';
//                                                            echo $test_4_not_invluded.'<br>';
//                                                            echo $test_5_not_invluded.'<br>';
