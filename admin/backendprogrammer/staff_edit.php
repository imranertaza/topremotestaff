...
if(!isset($_GET['tab']) || (isset($_GET['tab']) && $_GET['tab'] == "pending")) {
	$getProofReadData = mysqli_query($db, "SELECT * FROM ts_backendprogrammer_users WHERE status='0' ORDER BY date_created DESC");
	$proofReadResult = mysqli_fetch_all($getProofReadData, MYSQLI_ASSOC);
}
if(isset($_GET['tab']) && $_GET['tab'] == "approved") {
	$getProofReadApproved = mysqli_query($db, "SELECT * FROM ts_backendprogrammer_users WHERE status='1' ORDER BY date_updated DESC");
										...
										<div class="modal-content" style="width: 45%;">
											 ...
											 <div class="modal-body" style="padding-bottom:24px">
												...
												<?php
													...
													$getProofReadTestResult = mysqli_query($db, "SELECT * FROM ts_backendprogrammer_answers WHERE proofread_user_id='$id'");
...
<?php
														$q_id = $allQuestions[$q];
														$getSpecificQuestion = mysqli_query($db, "SELECT * FROM ts_backendprogrammer_questions WHERE id='$q_id'");
													...
													?>
															...
															<ul style="margin-top:5px;display:inline;padding-left:5px;">
																<?php
																	...
																	$getTestResultChoices = mysqli_query($db, "SELECT * FROM ts_backendprogrammer_question_choices WHERE question_id='$q_id'");
									...
									<div id="approveProofReadmodal<?php echo $proofReadResult[$x]['id']; ?>" class="modal">
										<div class="modal-content">
											 ...
											 <div class="modal-body">
													<form method="post" action="approve_Backendprogrammerg_staff.php" style="display:inline">
   ...
   <button type="submit" class="btn-success" style="font-size:12px;">Yes, as QC</button>
									...
									<div id="declineProofReadmodal<?php echo $proofReadResult[$x]['id']; ?>" class="modal">
										<div class="modal-content">
											 ...
											 <div class="modal-body">
												<form method="post" action="approve_Backendprogrammerg_staff.php">
													<input type="hidden" name="id" value="<?php echo $proofReadResult[$x]['id']; ?>">
								...
								<td>
									...
									<div id="deletePendingProofReadModal<?php echo $proofReadResult[$x]['id']; ?>" class="modal">
										<div class="modal-content">
											 ...
											 <div class="modal-body">
												<form method="post" action="remove_Backendprogrammerg_staff.php">
													<input type="hidden" name="id" value="<?php echo $proofReadResult[$x]['id']; ?>">
										...
										<div class="modal-content" style="width: 45%;">
											 ...
											 <div class="modal-body" style="padding-bottom:24px">
												...
												<?php
													...
													$getProofReadTestResult = mysqli_query($db, "SELECT * FROM ts_backendprogrammerg_answers WHERE proofread_user_id='$id'");
													$proofReadTestResult = mysqli_fetch_all($getProofReadTestResult, MYSQLI_ASSOC);
												...
												?>
													...
													<?php
														$q_id = $allQuestions[$q];
														$getSpecificQuestion = mysqli_query($db, "SELECT * FROM ts_backendprogrammerg_questions WHERE id='$q_id'");
														$specificQuestionResult = mysqli_fetch_all($getSpecificQuestion, MYSQLI_ASSOC);
													?>
															<p class="questions" style="margin-bottom:0px;"><span><?php echo $q + 1; ?>.</span> <?php echo $specificQuestionResult[0]['question']; ?></p>
															<ul style="margin-top:5px;display:inline;padding-left:5px;">
																<?php
																	...
																	$getTestResultChoices = mysqli_query($db, "SELECT * FROM ts_backendprogrammerg_question_choices WHERE question_id='$q_id'");
																	$choicesResult = mysqli_fetch_all($getTestResultChoices, MYSQLI_ASSOC);
				...
				<?php for($q = 0; $q < count($questionResult); $q++){ ?>
					...
					<ul style="margin-top:5px;display:inline;padding-left:5px;">
						<?php
							...
							$getChoices = mysqli_query($db, "SELECT * FROM ts_backendprogrammerg_question_choices WHERE question_id='$id'");
                                ...
                                <tbody>
                                        <tr>
                                                <td style="width:40%;vertical-align: top;border:0;">
                                                        ...
                                                        <br/>
                                                        <form action="save_Backendprogrammerg_approve_email_template.php" method="post">
                                                ...
                                                <td style="width:40%;vertical-align: top;border:0" class="follow-up-email-container">
                                                        <?php for($d = 0; $d < count($followupEmailTemplate); $d++){ ?>
                                                                <div class="follow-up-emails">
                                                                        ...
                                                                        <br/>
                                                                        <form action="save_Backendprogrammerg_followup_email_template.php" method="post">
...
<!--end email template-->
	...
	<div id="deleteAllModal" class="modal">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="remove_all_Backendprogrammerg_staff.php">
