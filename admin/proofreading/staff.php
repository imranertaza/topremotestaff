						...
						<?php if(mysqli_num_rows($getProofReadData) > 0){ ?>
							<?php for($x = 0; $x < count($proofReadResult); $x++){ ?>
								<tr>	
									...
									<td>
										<button class="btn-default" onclick="showTestResultModal(<?php echo $proofReadResult[$x]['id']; ?>)">View Test</button>
										<div id="viewTestResultModal<?php echo $proofReadResult[$x]['id']; ?>" class="modal">
											<div class="modal-content" style="width: 45%;">
												 <div class="modal-header">
													<span class="close" style="top: -10px;" onclick="closeModal(<?php echo "viewTestResultModal" . (string)$proofReadResult[$x]['id']; ?>)">×</span>
						...
						<?php if(!empty($approveProofReadResult)){ ?>
							<?php for($x = 0; $x < count($approveProofReadResult); $x++){ ?>
								<tr>	
									...
									<td>
										<button class="btn-default" onclick="showTestResultApprovedModal(<?php echo $approveProofReadResult[$x]['id']; ?>)">View Test</button>
