...
if (!isset($_GET['tab']) || (isset($_GET['tab']) && $_GET['tab'] == "pending")) {
    $getProofReadData = mysqli_query($db, "SELECT * FROM ts_proofread_users WHERE status='0' ORDER BY date_created DESC");
    $proofReadResult = mysqli_fetch_all($getProofReadData, MYSQLI_ASSOC);
}
if (isset($_GET['tab']) && $_GET['tab'] == "approved") {
    $getProofReadApproved = mysqli_query($db, "SELECT * FROM ts_proofread_users WHERE status='1' ORDER BY date_updated DESC");
...
if (isset($_GET['tab']) && $_GET['tab'] == "email_template") {
    $getApproveEmailTemplate = mysqli_query($db, "SELECT * FROM ts_proofread_approve_email_template");
    $approveEmailTemplate = mysqli_fetch_all($getApproveEmailTemplate, MYSQLI_ASSOC);

    $getFollowupEmailTemplate = mysqli_query($db, "SELECT * FROM ts_proofread_followup_email_template");
...
<head>
    ...
    <!--    <link rel="stylesheet" href="./css/proofreading.css">-->
        ...
        <div id="pending" class="tabcontent p-1 show">
            <table cellspacing="0">
                ...
                <tr>
                    ...
                    <th style="width:6%">
                        <button class="btn-danger" onclick="showDeleteAllPendingProofReadModal()">REMOVE ALL</button>
                    </th>
                </tr>
                </thead>
                <tbody>
                    ...
                    <?php if (mysqli_num_rows($getProofReadData) > 0) { ?>
                        <?php for ($x = 0; $x < count($proofReadResult); $x++) { ?>
                            <tr>
                                ...
                                <td><?php echo $proofReadResult[$x]['source']; ?></td>
                                <td class="score-total"><?php echo $proofReadResult[$x]['test_score']; ?>%</td>
                                <td>
                                    <button class="btn-default"
                                            onclick="showTestResultModal(<?php echo $proofReadResult[$x]['id']; ?>)">
                                        View Test
                                    </button>
                                    <div id="viewTestResultModal<?php echo $proofReadResult[$x]['id']; ?>"
                                         class="modal">
                                        <div class="modal-content" style="width: 45%;">
                                            <div class="modal-header">
                                                <span class="close" style="top: -10px;"
                                                      onclick="closeModal(<?php echo "viewTestResultModal" . (string)$proofReadResult[$x]['id']; ?>)">×</span>
                                            ...
                                            <div class="modal-body" style="padding-bottom:24px">
                                                <p style="margin-top:0;">Score: <span
                                                            style="color:#18AACF;font-weight:bold;"><?php echo $proofReadResult[$x]['test_score']; ?>%</span>
                                                </p>
                                                <div id="test_result_<?php echo $proofReadResult[$x]['id']; ?>"></div>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <button class="btn-success"
                                            onclick="showModal(<?php echo "approveProofReadmodal" . (string)$proofReadResult[$x]['id']; ?>)">
                                        APPROVE
                                    </button>
                                    <button class="btn-danger"
                                            onclick="showModal(<?php echo "declineProofReadmodal" . (string)$proofReadResult[$x]['id']; ?>)">
                                        DECLINE
                                    </button>
                                    <div id="approveProofReadmodal<?php echo $proofReadResult[$x]['id']; ?>"
                                         class="modal">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <span class="close"
                                                      onclick="closeModal(<?php echo "approveProofReadmodal" . (string)$proofReadResult[$x]['id']; ?>)">×</span>
                                                <h3 style="margin:0">Are you sure you want to approve?</h3>
                                            </div>
                                            <div class="modal-body">
                                                <form method="post" action="approve_proofread_staff.php"
                                                      style="display:inline">
                                                    <input type="hidden" name="id"
                                                           value="<?php echo $proofReadResult[$x]['id']; ?>">
                                                    <input type="hidden" name="email"
                                                           value="<?php echo $proofReadResult[$x]['email']; ?>">
                                                    <input type="hidden" name="fullname"
                                                           value="<?php echo $proofReadResult[$x]['fullname']; ?>">
                                    ...
                                    <div id="declineProofReadmodal<?php echo $proofReadResult[$x]['id']; ?>"
                                         class="modal">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <span class="close"
                                                      onclick="closeModal(<?php echo "declineProofReadmodal" . (string)$proofReadResult[$x]['id']; ?>)">×</span>
                                            ...
                                            <div class="modal-body">
                                                <form method="post" action="approve_proofread_staff.php">
                                                    ...
                                                    <input type="hidden" name="skype"
                                                           value="<?php echo $proofReadResult[$x]['skype']; ?>">
                                                    <input type="hidden" name="email"
                                                           value="<?php echo $proofReadResult[$x]['email']; ?>">
                                                    <input type="hidden" name="paypal"
                                                           value="<?php echo $proofReadResult[$x]['paypal']; ?>">
                                                    <input type="hidden" name="fullname"
                                                           value="<?php echo $proofReadResult[$x]['fullname']; ?>">
                                                    ...
                                                    <button type="button" class="btn-default" style="font-size:1rem;"
                                                            onclick="closeModal(<?php echo "declineProofReadmodal" . (string)$proofReadResult[$x]['id']; ?>)">
                                                        No
                                                    </button>
                                                </form>
                                            </div>
                                ...
                                <td>
                                    <button class="btn-danger"
                                            onclick="showModal(<?php echo "deletePendingProofReadModal" . (string)$proofReadResult[$x]['id']; ?>)">
                                        REMOVE
                                    </button>
                                    <div id="deletePendingProofReadModal<?php echo $proofReadResult[$x]['id']; ?>"
                                         class="modal">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <span class="close"
                                                      onclick="closeModal(<?php echo "deletePendingProofReadModal" . (string)$proofReadResult[$x]['id']; ?>)">×</span>
                                                <h3 style="margin:0">Are you sure you want to remove?</h3>
                                            </div>
                                            <div class="modal-body">
                                                <form method="post" action="remove_proofread_staff.php">
                                                    <input type="hidden" name="id"
                                                           value="<?php echo $proofReadResult[$x]['id']; ?>">
                                                    ...
                                                    <button type="button" class="btn-default" style="font-size:1rem;"
                                                            onclick="closeModal(<?php echo "deletePendingProofReadModal" . (string)$proofReadResult[$x]['id']; ?>)">
                                                        No
                                                    </button>
                                                </form>
                                            </div>
                                ...
                                <td>
                                    <center><input type="checkbox" class="remove_all" name="remove_all[]"
                                                   value="<?php echo $proofReadResult[$x]['id']; ?>"></center>
                                </td>
                            </tr>
                        <?php } ?>
                    <?php } else { ?>
        ...
        <div id="approved" class="tabcontent p-1 show">
            <table cellspacing="0">
                ...
                <tr>
                    ...
                    <th style="width:6%">Delete</th>
                    <th>
                        <button class="btn-danger" onclick="showDeleteAllApprovedProofReadModal()">REMOVE ALL</button>
                    </th>
                </tr>
                </thead>
                <tbody>
                    ...
                    <?php if (!empty($approveProofReadResult)) { ?>
                        <?php for ($x = 0; $x < count($approveProofReadResult); $x++) { ?>
                            <tr>
                                ...
                                <td>
                                    <?php
                                    if ($approveProofReadResult[$x]['account_type'] == 1) {
                                        echo "EDITOR";
                                    } else {
                                        echo "QC";
                                    }
                                ...
                                <td>
                                    <button class="btn-default"
                                            onclick="showTestResultApprovedModal(<?php echo $approveProofReadResult[$x]['id']; ?>)">
                                        View Test
                                    </button>
                                    <div id="viewApproveTestModal<?php echo $approveProofReadResult[$x]['id']; ?>"
                                         class="modal">
                                        <div class="modal-content" style="width: 45%;">
                                            <div class="modal-header">
                                                <span class="close" style="top: -10px;"
                                                      onclick="closeModal(<?php echo "viewApproveTestModal" . (string)$approveProofReadResult[$x]['id']; ?>)">×</span>
                                                <h4 style="margin:0">Test Result: Multiple Choice</h4>
                                            </div>
                                            <div class="modal-body" style="padding-bottom:24px">
                                                <p style="margin-top:0;">Score: <span
                                                            style="color:#18AACF;font-weight:bold;"><?php echo $approveProofReadResult[$x]['test_score']; ?>%</span>
                                                </p>
                                                <div id="approved_test_result_<?php echo $approveProofReadResult[$x]['id']; ?>"></div>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <button class="btn-danger"
                                            onclick="showModal(<?php echo "deleteApprovedProofReadModal" . (string)$approveProofReadResult[$x]['id']; ?>)">
                                        REMOVE
                                    </button>
                                    <div id="deleteApprovedProofReadModal<?php echo $approveProofReadResult[$x]['id']; ?>"
                                         class="modal">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <span class="close"
                                                      onclick="closeModal(<?php echo "deleteApprovedProofReadModal" . (string)$approveProofReadResult[$x]['id']; ?>)">×</span>
                                                <h3 style="margin:0">Are you sure you want to remove?</h3>
                                            </div>
                                            <div class="modal-body">
                                                <form method="post" action="remove_proofread_staff.php">
                                                    <input type="hidden" name="id"
                                                           value="<?php echo $approveProofReadResult[$x]['id']; ?>">
                                                    <input type="hidden" name="check" value="2">
                                                    <button type="submit" class="btn-danger" style="font-size:1rem;">
                                                        Yes
                                                    </button>
                                                    <button type="button" class="btn-default" style="font-size:1rem;"
                                                            onclick="closeModal(<?php echo "deleteApprovedProofReadModal" . (string)$approveProofReadResult[$x]['id']; ?>)">
                                                        No
                                                    </button>
                                                </form>
                                            </div>
            ...
            <table style="border:0;">
                ...
                <tr>
                    <td style="width:40%;vertical-align: top;border:0;">
                        ...
                        <br/>
                        <small>AUTO CREATE ACCOUNT</small>&ensp;<strong style="font-size: 12px;">JOB TYPE:
                            EDITOR</strong>
                        <br/>
                        <form action="save_proofread_approve_email_template.php" method="post">
                        ...
                        <form action="save_proofread_approve_email_template.php" method="post">
                            ...
                            <textarea name="content" rows="15"
                                      style="width:100%;"><?php if (array_key_exists(3, $approveEmailTemplate)) {
...
<div id="deleteAllModal" class="modal">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="post" action="remove_all_proofread_staff.php">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="post" action="remove_all_proofread_staff.php">
                ...
                <button type="submit" class="btn-danger" style="font-size:1rem;">Yes</button>
                <button type="button" class="btn-default" style="font-size:1rem;"
                        onclick="closeDeleteAllProofReadModal()">No
                </button>
            </form>
        </div>
    </div>
...
<script>
    ...
    function openTab(evt, cityName) {
        ...
        if (cityName == "approved" || cityName == "pending" || cityName == "mc_questions" || cityName == "email_template" || cityName == "proofread") {
