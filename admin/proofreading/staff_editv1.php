...
$crud = new Crud();
/*
$getData = mysqli_query($db, "SELECT * FROM ts_proofread_users WHERE status='0' ORDER BY date_created DESC");
$result = mysqli_fetch_all($getData, MYSQLI_ASSOC);

$getApproved = mysqli_query($db, "SELECT * FROM ts_proofread_users WHERE status='1' ORDER BY date_updated DESC");
