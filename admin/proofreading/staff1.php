...
function myFunction() {
  ...
  table = document.getElementById("precentfilter");
...
-->
		...
		<!--<div id="proofread_pending" class="tabcontent show p-1 "> -->
			<table cellspacing="0"  id="precentfilter">
				<thead>
					<tr>
						...
						<th>
<select name="staffpage" id="myInput" onchange="myFunction()" >
<option value="50%">Minimum 50%</option>
<option value="60%">Minimum 60%</option>
<option value="70%">Minimum 70%</option>
<option value="75%">Minimum 75%</option>
<option value="80%">Minimum 80%</option>
<option value="85%">Minimum 85%</option>    
  </select>
			<button class="btn-danger" onclick="showDeleteAllPendingProofReadModal()">REMOVE ALL</button></th>
					</tr>
				</thead>
				<tbody>
										...
										<div class="modal-content" style="width: 45%;">
											 ...
											 <div class="modal-body" style="padding-bottom:24px">
												...
												<?php
													...
													//echo "SELECT * FROM ts_proofread_answers WHERE proofread_user_id='$id'";
...
<?php
														$q_id = $allQuestions[$q];
														//echo "SELECT * FROM ts_questions WHERE id='$q_id'<BR>";
									...
									<div id="approveProofReadmodal<?php echo $proofReadResult[$x]['id']; ?>" class="modal">
										<div class="modal-content">
											 ...
											 <div class="modal-body">
													<form method="post" action="approve_proofread_staff.php" style="display:inline">
