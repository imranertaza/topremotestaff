...
$FileUpload = new FileUpload();
    ...
    foreach($allIds as $id) {
        $selectQuery = $crud->getSelectedData('cv', 'ts_frontendprogrammer_users', "id", $id);
    ...
    $queryQu = $crud->deleteAll('ts_frontendprogrammer_answers', "id", $_POST['staff_ids']);
    $db->query($queryQu);
    //deleting question answer

	$query = $crud->deleteAll('ts_frontendprogrammer_users', "id", $_POST['staff_ids']);
