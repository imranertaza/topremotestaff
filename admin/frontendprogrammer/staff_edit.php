...
if(!isset($_GET['tab']) || (isset($_GET['tab']) && $_GET['tab'] == "pending")) {
	$getProofReadData = mysqli_query($db, "SELECT * FROM ts_frontendprogrammer_users WHERE status='0' ORDER BY date_created DESC");
	$proofReadResult = mysqli_fetch_all($getProofReadData, MYSQLI_ASSOC);
}
if(isset($_GET['tab']) && $_GET['tab'] == "approved") {
	$getProofReadApproved = mysqli_query($db, "SELECT * FROM ts_frontendprogrammer_users WHERE status='1' ORDER BY date_updated DESC");
...
-->
		...
		<?php if(!empty($_GET)){ ?>
				...
				<div id="pending" class="tabcontent p-1 show">
                        <?php }else if($_GET['tab'] == "mc_questions"){ ?>
				<div id="pending" class="tabcontent p-1">
			<?php }else if($_GET['tab'] == "email_template"){ ?>
                                <div id="pending" class="tabcontent p-1">
                        <?php }else{ ?>
                                <div id="pending" class="tabcontent p-1">
                        <?php } ?>
										...
										<div class="modal-content" style="width: 45%;">
											 ...
											 <div class="modal-body" style="padding-bottom:24px">
												...
												<?php
													...
													$getProofReadTestResult = mysqli_query($db, "SELECT * FROM ts_frontendprogrammer_answers WHERE proofread_user_id='$id'");
...
<?php
														$q_id = $allQuestions[$q];
														$getSpecificQuestion = mysqli_query($db, "SELECT * FROM ts_frontendprogrammer_questions WHERE id='$q_id'");
													...
													?>
															...
															<ul style="margin-top:5px;display:inline;padding-left:5px;">
																<?php
																	...
																	$getTestResultChoices = mysqli_query($db, "SELECT * FROM ts_frontendprogrammer_question_choices WHERE question_id='$q_id'");
...
//																				echo "Ans:".$allAnswers[$q]." Correct:".$choicesResult[$c]['correct']."<BR>";
																			...
																			//if($allAnswers[$q] == $choicesResult[$c]['correct']) {	
//																				echo "<li style='padding:0 1rem;display:inline;'>&#9675; <span>" . $choicesResult[$c]['description'] . "</span></li>";
																				echo "<li style='padding:0 1rem;display:inline;color:red;'><span>" . $choicesResult[$c]['description'] . "</span></li>";
																			} else {
																				echo "<li style='padding:0 1rem;display:inline;color:black;'><strong>" . $choicesResult[$c]['description'] . "</strong></li>";
									...
									<div id="approveProofReadmodal<?php echo $proofReadResult[$x]['id']; ?>" class="modal">
										<div class="modal-content">
											 ...
											 <div class="modal-body">
													<form method="post" action="approve_Frontendprogrammerg_staff.php" style="display:inline">
   ...
   <button type="submit" class="btn-success" style="font-size:12px;">Yes, as QC</button>
									...
									<div id="declineProofReadmodal<?php echo $proofReadResult[$x]['id']; ?>" class="modal">
										<div class="modal-content">
											 ...
											 <div class="modal-body">
												<form method="post" action="approve_Frontendprogrammerg_staff.php">
													<input type="hidden" name="id" value="<?php echo $proofReadResult[$x]['id']; ?>">
								...
								<td>
									...
									<div id="deletePendingProofReadModal<?php echo $proofReadResult[$x]['id']; ?>" class="modal">
										<div class="modal-content">
											 ...
											 <div class="modal-body">
												<form method="post" action="remove_Frontendprogrammerg_staff.php">
													<input type="hidden" name="id" value="<?php echo $proofReadResult[$x]['id']; ?>">
													<input type="hidden" name="check" value="1">
													<button type="submit" class="btn-danger" style="font-size:1rem;">Yes</button>
													<button type="button" class="btn-default" style="font-size:1rem;" onclick="closeModal(<?php echo "deletePendingProofReadModal" . (string)$proofReadResult[$x]['id']; ?>)">No</button>
												</form>
											</div>
										</div>
									</div>
										...
										<div class="modal-content" style="width: 45%;">
											 ...
											 <div class="modal-body" style="padding-bottom:24px">
												...
												<?php
													...
													$getProofReadTestResult = mysqli_query($db, "SELECT * FROM ts_frontendprogrammerg_answers WHERE proofread_user_id='$id'");
													$proofReadTestResult = mysqli_fetch_all($getProofReadTestResult, MYSQLI_ASSOC);
												...
												?>
													...
													<?php
														$q_id = $allQuestions[$q];
														$getSpecificQuestion = mysqli_query($db, "SELECT * FROM ts_frontendprogrammerg_questions WHERE id='$q_id'");
														$specificQuestionResult = mysqli_fetch_all($getSpecificQuestion, MYSQLI_ASSOC);
													?>
															<p class="questions" style="margin-bottom:0px;"><span><?php echo $q + 1; ?>.</span> <?php echo $specificQuestionResult[0]['question']; ?></p>
															<ul style="margin-top:5px;display:inline;padding-left:5px;">
																<?php
																	...
																	$getTestResultChoices = mysqli_query($db, "SELECT * FROM ts_frontendprogrammerg_question_choices WHERE question_id='$q_id'");
																	$choicesResult = mysqli_fetch_all($getTestResultChoices, MYSQLI_ASSOC);
...
<!--		<div id="multiple_test" class="tabcontent p-1 "> -->
		<?php if(!isset($_GET['tab']) || $_GET['tab'] == "mc_questions"){ ?>
				...
				<?php for($q = 0; $q < count($questionResult); $q++){ ?>
					...
					<ul style="margin-top:5px;display:inline;padding-left:5px;">
						<?php
							...
							$getChoices = mysqli_query($db, "SELECT * FROM ts_frontendprogrammerg_question_choices WHERE question_id='$id'");
...
<!--start email template-->
		<?php if(!empty($_GET)){ ?>
                ...
                <?php } ?>
		<!--<div id="email_template" class="tabcontent p-1"> -->
		<?php if(!isset($_GET['tab']) || $_GET['tab'] == "email_template"){ ?>
                        ...
                        <table style="border:0;">
                                <tbody>
                                        <tr>
                                                <td style="width:40%;vertical-align: top;border:0;">
                                                        ...
                                                        <br/>
                                                        <form action="save_Frontendprogrammerg_approve_email_template.php" method="post">
							...
							<br/>
                                                                ...
                                                                <form action="save_Frontendprogrammerg_approve_email_template.php" method="post">
                                                                        ...
                                                                        <textarea name="content" rows="15" style="width:100%;"><?php if (array_key_exists(3, $approveEmailTemplate)) { echo htmlentities(urldecode($approveEmailTemplate[3]['content'])); } ?></textarea>
                                                                        <button type="submit" class="btn-success" style="font-size:12px;">UPDATE</button>
                                                                </form>
                                                </td>
                                                <td style="width:40%;vertical-align: top;border:0" class="follow-up-email-container">
                                                        <?php for($d = 0; $d < count($followupEmailTemplate); $d++){ ?>
                                                                <div class="follow-up-emails">
                                                                        ...
                                                                        <br/>
                                                                        <form action="save_Frontendprogrammerg_followup_email_template.php" method="post">
...
<!--end email template-->
	...
	<div id="deleteAllModal" class="modal">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="remove_all_Frontendprogrammerg_staff.php">
