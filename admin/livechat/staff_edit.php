...
if(!isset($_GET['tab']) || (isset($_GET['tab']) && $_GET['tab'] == "pending")) {
	$getProofReadData = mysqli_query($db, "SELECT * FROM ts_livechat_users WHERE status='0' ORDER BY date_created DESC");
	$proofReadResult = mysqli_fetch_all($getProofReadData, MYSQLI_ASSOC);
}
if(isset($_GET['tab']) && $_GET['tab'] == "approved") {
	$getProofReadApproved = mysqli_query($db, "SELECT * FROM ts_livechat_users WHERE status='1' ORDER BY date_updated DESC");
										...
										<div class="modal-content" style="width: 45%;">
											 ...
											 <div class="modal-body" style="padding-bottom:24px">
												...
												<?php
													...
													$getProofReadTestResult = mysqli_query($db, "SELECT * FROM ts_livechat_answers WHERE proofread_user_id='$id'");
...
<?php
														$q_id = $allQuestions[$q];
														$getSpecificQuestion = mysqli_query($db, "SELECT * FROM ts_livechat_questions WHERE id='$q_id'");
													...
													?>
															...
															<ul style="margin-top:5px;display:inline;padding-left:5px;">
																<?php
																	...
																	$getTestResultChoices = mysqli_query($db, "SELECT * FROM ts_livechat_question_choices WHERE question_id='$q_id'");
									...
									<div id="approveProofReadmodal<?php echo $proofReadResult[$x]['id']; ?>" class="modal">
										<div class="modal-content">
											 ...
											 <div class="modal-body">
													<form method="post" action="approve_livechat_staff.php" style="display:inline">
